...
require_text docs/src/content/docs/operations/upgrades.md 'V1 through V21'
require_text docs/src/content/docs/operations/key-management.md '256-bit AES'
require_text docs/src/content/docs/operations/capacity-planning.md 'max-concurrent-runs + 4'
require_text docs/src/content/docs/operations/health-and-metrics.md 'replicadb.managed.lease.renewals'
require_text docs/src/content/docs/operations/failure-recovery.md 'never resumes'
require_text docs/src/content/docs/server/runs-and-diagnostics.mdx 'bounded diagnostic log'
require_text docs/src/content/docs/operations/upgrades.md 'RAMJobStore to JDBC handoff'
require_text docs/CONTRIBUTING.md 'update-openapi.sh'
require_text docs/CONTRIBUTING.md 'test:e2e:docs'
require_text docs/CONTRIBUTING.md 'connector-capabilities.json'
require_text docs/CONTRIBUTING.md 'architecture/operations page'
