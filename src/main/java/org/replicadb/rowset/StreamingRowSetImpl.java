...
public class StreamingRowSetImpl extends BaseRowSet implements RowSet, RowSetInternal, Serializable {
    ...
    * current source of data for this <code>StreamingRowSetImpl</code> object.
    */
   private transient ResultSetMetaData RSMD;

   /**
    * The <code>RowSetMetaData</code> object that contains information about
    * the columns in this <code>StreamingRowSetImpl</code> object.
    * @serial
    */
    ...
    * objects that comprise  this <code>StreamingRowSetImpl</code> object.
    * @serial
    */
   ...
   /**
    * Constructs a new default <code>StreamingRowSetImpl</code> object with
   ...
   /**
    * Provides a <code>StreamingRowSetImpl</code> instance with the same default properties as
    ...
    * <p>
    * For example, creating a <code>StreamingRowSetImpl</code> object as follows ensures
   ...
   /**
    * Sets the properties for this <code>StreamingRowSetImpl</code> object to
   ...
   /**
    * Populates this <code>StreamingRowSetImpl</code> object with data from
    ...
    *             to be read into this <code>StreamingRowSetImpl</code> object
   ...
   /**
    * Populates this <code>StreamingRowSetImpl</code> object with data,
   ...
   /**
    * Sets this <code>StreamingRowSetImpl</code> object's connection property
    ...
    * <code>StreamingRowSetImpl</code> object can retrieve the connection stored
    ...
    *                   in this <code>StreamingRowSetImpl</code> object's connection
    *                   property
    */
   ...
   /**
    * Releases the current contents of this <code>StreamingRowSetImpl</code>
   ...
   /**
    * Moves this <code>StreamingRowSetImpl</code> object's cursor to the next
   ...
   /**
    * Closes this <code>StreamingRowSetImpl</code> objecy and releases any resources
    * it was using.
    *
    * @throws SQLException if an error occurs when releasing any resources in use
    * by this <code>StreamingRowSetImpl</code> object
    */
    ...
    * in this <code>StreamingRowSetImpl</code> object and throws
    ...
    *
    * @param idx the number of a column in this <code>StreamingRowSetImpl</code>
    ...
    *
    * @throws SQLException if the cursor for this <code>StreamingRowSetImpl</code>
    ...
    *
    * @return the <code>Row</code> object on which this <code>StreamingRowSetImpl</code>
    ...
    * of this <code>StreamingRowSetImpl</code> object as a
   ...
   /**
    * Retrieves the value of the designated column in the current row
    * of this <code>StreamingRowSetImpl</code> object as an
    * <code>int</code> value.
    *
    * @param columnIndex the first column is <code>1</code>, the second
    *        is <code>2</code>, and so on; must be <code>1</code> or larger
    ...
    * stream may return <code>0</code> for <code>StreamingRowSetImpl.available()</code>
    ...
    * <code>StreamingRowSetImpl.available()</code> whether there is data
    * available or not.
    *
    * @param columnIndex the first column is <code>1</code>, the second
    * is <code>2</code>, and so on; must be <code>1</code> or larger
    ...
    *        a column in this <code>StreamingRowSetImpl</code> object
   ...
   /**
    * Retrieves the value stored in the designated column
    * of the current row of this <code>StreamingRowSetImpl</code> object
    ...
    *
    * @return the SQL cursor name for this <code>StreamingRowSetImpl</code> object's
    *         cursor
    * @throws SQLException if an error occurs
    */
    ...
    * meta data; or if the <code>StreamingRowSetImpl</code> is empty.
   ...
   public Object getObject(int columnIndex) throws SQLException {
      ...
      if (value instanceof Struct) {
         throw new UnsupportedOperationException("ReplicaDB RowSet Implementation does not support getObject for Struct");
      }
      return value;
   }
   ...
   /**
    * Moves this <code>StreamingRowSetImpl</code> object's cursor to the end of
   ...
   /**
    * Moves this <code>StreamingRowSetImpl</code> object's cursor to the first
   ...
   /**
    * Moves this <code>StreamingRowSetImpl</code> object's cursor to the last
    * row and returns <code>true</code> if the operation is successful.
    * <P>
   ...
   /**
    * Returns the number of the current row in this <code>StreamingRowSetImpl</code>
    ...
    * <code>crs</code> is a <code>StreamingRowSetImpl</code> object, moves the cursor
    ...
    * If the <code>StreamingRowSetImpl</code> object <code>crs</code> has five rows,
    ...
    * <code>crs</code> is a <code>StreamingRowSetImpl</code> object with 100 rows,
    ...
    *         <code>StreamingRowSetImpl</code> object; <code>false</code>
    *         otherwise
   ...
   /**
    * Moves this <code>StreamingRowSetImpl</code> object's cursor to the
    ...
    * <code>StreamingRowSetImpl</code> object that its cursor has moved.
    * <P>
    ...
    * the <code>StreamingRowSetImpl</code> object <code>crs</code>, which has
    ...
    * this <code>StreamingRowSetImpl</code> object has been updated. The
    ...
    * insert row of this <code>StreamingRowSetImpl</code> object with
    ...
    * row of this <code>StreamingRowSetImpl</code> object with the given
    * <code>boolean</code> value.
    * <P>
    * This method updates a column value in the current row or the insert
    ...
    * <code>StreamingRowSetImpl</code> object and notifies listeners that
   ...
   /**
    * Moves the cursor for this <code>StreamingRowSetImpl</code> object
    ...
    * undetermined.
    *
    * @throws SQLException if this <code>StreamingRowSetImpl</code> object is
    *            <code>ResultSet.CONCUR_READ_ONLY</code>
    */
   ...
   /**
    * Moves the cursor for this <code>StreamingRowSetImpl</code> object to
    ...
    * <code>StreamingRowSetImpl</code> object as an <code>Object</code> in
       ...
       throws SQLException
   {
      ...
      if (value instanceof Struct) {
         throw new UnsupportedOperationException("ReplicaDB RowSet Implementation does not support getObject from Struct");
      }
      return value;
   }
   ...
   /**
    * Retrieves the value of the designated column in this
    * <code>StreamingRowSetImpl</code> object as a <code>Ref</code> object
   ...
   /**
    * Retrieves the value of the designated column in this
    * <code>StreamingRowSetImpl</code> object as a <code>Blob</code> object
    * in the Java programming language.
    *
    * @param columnIndex the first column is <code>1</code>, the second
    *        is <code>2</code>, and so on; must be <code>1</code> or larger
   ...
   /**
    * Retrieves the value of the designated column in this
    * <code>StreamingRowSetImpl</code> object as a <code>Clob</code> object
    * in the Java programming language.
    *
    * @param columnIndex the first column is <code>1</code>, the second
    *        is <code>2</code>, and so on; must be <code>1</code> or larger
   ...
   /**
    * Retrieves the value of the designated column in this
    * <code>StreamingRowSetImpl</code> object as an <code>Array</code> object
    * in the Java programming language.
    *
    * @param columnIndex the first column is <code>1</code>, the second
    *        is <code>2</code>, and so on; must be <code>1</code> or larger
   ...
   /**
    * Retrieves the value of the designated column in the current row
    * of this <code>StreamingRowSetImpl</code> object as a <code>java.sql.Date</code>
   ...
   /**
    * Retrieves the value of the designated column in the current row
    * of this <code>StreamingRowSetImpl</code> object as a <code>java.sql.Time</code>
    * object, using the given <code>Calendar</code> object to construct an
    * appropriate millisecond value for the date.
    *
    * @param columnIndex the first column is <code>1</code>, the second
   ...
   /**
    * Retrieves the value of the designated column in the current row
    * of this <code>StreamingRowSetImpl</code> object as a <code>java.sql.Timestamp</code>
    * object, using the given <code>Calendar</code> object to construct an
    * appropriate millisecond value for the date.
    *
    * @param columnIndex the first column is <code>1</code>, the second
    ...
    * <code>StreamingRowSetImpl</code> object.  This connection may be
   ...
   /**
    * Sets the metadata for this <code>StreamingRowSetImpl</code> object
    ...
    *         which this <code>StreamingRowSetImpl</code> object was derived
    * @throws SQLException if an error occurs
    */
    ...
    *          table from which this <code>StreamingRowSetImpl</code> object
    *          was derived
    * @throws SQLException if an error occurs
    */
    ...
    * row in this <code>StreamingRowSetImpl</code> object.
    *
   ...
   /**
    * Sets this <code>StreamingRowSetImpl</code> object's
    ...
    *        <code>StreamingRowSetImpl</code> object; every
   ...
   /**
    * The nextPage gets the next page, that is a <code>StreamingRowSetImpl</code> object
