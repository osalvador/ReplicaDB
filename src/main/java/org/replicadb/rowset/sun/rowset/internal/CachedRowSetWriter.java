...
package org.replicadb.rowset.sun.rowset.internal;

import org.replicadb.rowset.sun.rowset.CachedRowSetImpl;
import org.replicadb.rowset.sun.rowset.JdbcRowSetResourceBundle;
          ...
          for (i = 1; i <= callerColumnCount; i++) {
                ...
                if (rsval instanceof Struct) {
                    ...
                    if (c != null) {
                        ...
                        SQLData obj = null;
                            throw new SQLException("Unable to Instantiate: TODO from ReplicaDB");
                        /*try {
