...
@Testcontainers
class MySQL2CsvFileTest {
    private static final Logger LOG = LogManager.getLogger(MySQL2CsvFileTest.class);
    private static final String RESOURCE_DIR = Paths.get("src", "test", "resources").toFile().getAbsolutePath();
    private static final String REPLICADB_CONF_FILE = "/replicadb.conf";
    private static final int EXPECTED_ROWS = 4097;

    private static final String SINK_FILE_PATH = "file:///tmp/mysql2csv_sink.csv";
    private static final String SINK_FILE_URI_PATH = "file:///tmp/mysql2csv_sink.csv";
    ...
    @Test
    void testMySQL2CsvFileComplete() throws ParseException, IOException {
        String[] args = {
    ...
    @Test
    void testMySQL2CsvFileCompleteParallel() throws ParseException, IOException {
        String[] args = {
                "--options-file", RESOURCE_DIR + REPLICADB_CONF_FILE,
                "--source-connect", mysql.getJdbcUrl(),
                "--source-user", mysql.getUsername(),
