...
class Mongo2SqliteTest {
    ...
    @Test
    void testMongodb2SqliteComplete() throws ParseException, IOException, SQLException {
        String[] args = {
    ...
    @Test
    void testMongodb2SqliteCompleteParallel() throws ParseException, IOException, SQLException {
        String[] args = {
                "--options-file", RESOURCE_DIR + REPLICADB_CONF_FILE,
                "--source-connect", mongoContainer.getReplicaSetUrl(),
                "--sink-connect", sqlite.getJdbcUrl(),
