...
class Mongo2MariaDBTest {
    ...
    @Test
    void testMongodb2MariaDBComplete() throws ParseException, IOException, SQLException {
        String[] args = {
    ...
    @Test
    void testMongodb2MariaDBCompleteParallel() throws ParseException, IOException, SQLException {
        String[] args = {
                "--options-file", RESOURCE_DIR + REPLICADB_CONF_FILE,
                "--source-connect", mongoContainer.getReplicaSetUrl(),
                "--sink-connect", mariadb.getJdbcUrl(),
    ...
    @Test
    void testMongodb2MariaDBCompleteAtomic() throws ParseException, IOException, SQLException {
        String[] args = {
                "--options-file", RESOURCE_DIR + REPLICADB_CONF_FILE,
                "--source-connect", mongoContainer.getReplicaSetUrl(),
                "--sink-connect", mariadb.getJdbcUrl(),
    ...
    @Test
    void testMongodb2MariaDBIncremental() throws ParseException, IOException, SQLException {
        String[] args = {
                "--options-file", RESOURCE_DIR + REPLICADB_CONF_FILE,
                "--source-connect", mongoContainer.getReplicaSetUrl(),
                "--sink-connect", mariadb.getJdbcUrl(),
