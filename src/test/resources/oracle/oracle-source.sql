...
create table t_source (
    ...
    C_SMALLINT SMALLINT,
    C_BIGINT NUMBER(19)	,
    C_NUMERIC NUMERIC(38,30),
    C_DECIMAL DECIMAL(38,30),
...
select
    ...
    CAST(generate_series * DBMS_RANDOM.NORMAL() as decimal(38, 30)) as C_NUMERIC,
    CAST(generate_series * DBMS_RANDOM.NORMAL() as decimal(38, 30)) as C_DECIMAL,
    CAST(generate_series * DBMS_RANDOM.NORMAL() as decimal(38, 10)) as C_REAL,
    CAST(generate_series * DBMS_RANDOM.NORMAL() as decimal(38, 10)) as C_DOUBLE_PRECISION,
    CAST(generate_series * DBMS_RANDOM.NORMAL() as decimal(38, 10)) as C_FLOAT,
