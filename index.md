...
```bash
$ curl -o ReplicaDB-0.11.2.tar.gz -L "https://github.com/osalvador/ReplicaDB/releases/download/v0.11.2/ReplicaDB-0.11.2.tar.gz"
$ tar -xvzf ReplicaDB-0.11.2.tar.gz
$ ./bin/replicadb --help
```
