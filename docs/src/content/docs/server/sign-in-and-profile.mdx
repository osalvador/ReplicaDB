...
import loginMobile from '../../../assets/screenshots/server/login-mobile.png';
...
<ScreenshotFrame src={loginMobile} alt="ReplicaDB mobile sign-in form" caption="The sign-in flow remains readable on a narrow viewport." width={390} height={844} />
