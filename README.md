...
| Download | `ReplicaDB-1.0.1.tar.gz` or `.zip` | `ReplicaDB-server-1.0.1.tar.gz` or `.zip` |
...
```bash
$ curl -o ReplicaDB-1.0.1.tar.gz -L "https://github.com/osalvador/ReplicaDB/releases/download/v1.0.1/ReplicaDB-1.0.1.tar.gz"
$ tar -xvzf ReplicaDB-1.0.1.tar.gz
$ ./bin/replicadb --help
```
