...
```bash
$ curl -o ReplicaDB-0.11.8.tar.gz -L "https://github.com/osalvador/ReplicaDB/releases/download/v0.11.8/ReplicaDB-0.11.8.tar.gz"
$ tar -xvzf ReplicaDB-0.11.8.tar.gz
$ ./bin/replicadb --help
```
