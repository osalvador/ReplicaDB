...
```bash
$ curl -o ReplicaDB-0.11.7.tar.gz -L "https://github.com/osalvador/ReplicaDB/releases/download/v0.11.7/ReplicaDB-0.11.7.tar.gz"
$ tar -xvzf ReplicaDB-0.11.7.tar.gz
$ ./bin/replicadb --help
```
