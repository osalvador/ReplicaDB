...
```bash
$ curl -o ReplicaDB-0.14.0.tar.gz -L "https://github.com/osalvador/ReplicaDB/releases/download/v0.14.0/ReplicaDB-0.14.0.tar.gz"
$ tar -xvzf ReplicaDB-0.14.0.tar.gz
$ ./bin/replicadb --help
```
