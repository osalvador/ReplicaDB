...
```bash
$ curl -o ReplicaDB-0.10.5.tar.gz -L "https://github.com/osalvador/ReplicaDB/releases/download/v0.10.5/ReplicaDB-0.10.5.tar.gz"
$ tar -xvzf ReplicaDB-0.10.5.tar.gz
$ ./bin/replicadb --help
```
