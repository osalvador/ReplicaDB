...
```bash
$ curl -o ReplicaDB-0.12.3.tar.gz -L "https://github.com/osalvador/ReplicaDB/releases/download/v0.12.3/ReplicaDB-0.12.3.tar.gz"
$ tar -xvzf ReplicaDB-0.12.3.tar.gz
$ ./bin/replicadb --help
```
