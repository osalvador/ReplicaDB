...
path_is_known_untracked() {
    case "$1" in
        implementation_plan.md|implementation_plan_doc.md|shape-datasources.png|.ai|.ai/*|docs/astro.config.mjs|docs/package-lock.json|docs/package.json|docs/public|docs/public/*|docs/scripts|docs/scripts/*|docs/src|docs/src/*|docs/tests|docs/tests/*|docs/tsconfig.json|docs/node_modules|docs/node_modules/*|docs/dist|docs/dist/*|docs/.astro|docs/.astro/*|docs/.starlight|docs/.starlight/*|docs/test-results|docs/test-results/*|docs/playwright-report|docs/playwright-report/*|replicadb-server/frontend/.impeccable|replicadb-server/frontend/.impeccable/*)
            return 0
            ;;
        *)
            return 1
